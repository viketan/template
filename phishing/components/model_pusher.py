...
import os,sys
from phishing.utils import load_object,save_object
from phishing.logger import logging
from phishing.entity.artifact_entity import DataTransformationArtifact,ModelTrainerArtifact,ModelPusherArtifact
class ModelPusher:
